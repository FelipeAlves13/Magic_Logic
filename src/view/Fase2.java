...
public class Fase2 extends Fase {
	...
	public void inicializarCoordenadasDoPercurso() {
		...
		this.getRetangulosPercursoVerticalBaixo().add(new Rectangle(520,290,80,20));//1
		this.getRetangulosPercursoVerticalBaixo().add(new Rectangle(520,180,80,20));//2
		this.getRetangulosPercursoVerticalBaixo().add(new Rectangle(20,170,40,20));//3
		this.getRetangulosPercursoVerticalBaixo().add(new Rectangle(380,170,40,20));//4
		
		//ESTREMIDADES
		this.getRetangulosPercursoVerticalBaixo().add(new Rectangle(280,470,40,20));//5
		this.getRetangulosPercursoVerticalBaixo().add(new Rectangle(180,290,40,20));//6
		this.getRetangulosPercursoVerticalBaixo().add(new Rectangle(380,290,40,20));//7
		this.getRetangulosPercursoVerticalBaixo().add(new Rectangle(520,470,80,20));//teleporte//8
		this.getRetangulosPercursoVerticalBaixo().add(new Rectangle(80,390,40,20));
		this.getRetangulosPercursoVerticalBaixo().add(new Rectangle(20,470,40,20));
		...
		this.getRetangulosPercursoVerticalCima().add(new Rectangle(20,120,40,30));
		...
		//HORIZONTAL DIREITA
		//CAMPO ABERTO
		this.getRetangulosPercursoHorizontalDireita().add(new Rectangle(320,460,30,20));//0//teleporte
		this.getRetangulosPercursoHorizontalDireita().add(new Rectangle(320,280,30,20));//1
		...
		//ESTREMIDADES
		this.getRetangulosPercursoHorizontalDireita().add(new Rectangle(560,460,20,20));
		...
		this.getRetangulosPercursoHorizontalDireita().add(new Rectangle(560,140,30,30));//11
		...
		//ESTREMIDADES
		this.getRetangulosPercursoHorizontalEsquerda().add(new Rectangle(160,260,30,20));
		this.getRetangulosPercursoHorizontalEsquerda().add(new Rectangle(0,140,30,20));//
		this.getRetangulosPercursoHorizontalEsquerda().add(new Rectangle(0,460,30,20));
